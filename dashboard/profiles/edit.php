            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Edit <?= $page; ?> <b><?php echo htmlspecialchars(ucfirst($data['nama'])); ?></b></h4>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <form method="post" action="<?php echo $url; ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                                        <div class="row mt-3">
                                            <div class="col-md-3 mt-3">
                                                <div class="text-center position-relative">
                                                    ...
                                                    if ($_SESSION['gambar'] == null) {
                                                        ...
                                                        echo '
                                                        <img src="../../assets/images/users/' . $data["gambar"] . '" alt="image" class="img-fluid rounded-circle border border-secondary" width="200" />
                                                        ';
                                                    }
                                                    ?>
                                                </div>
                                            ...
                                            <div class="col-md-3 mt-3">
                                                ...
                                                <input type="text" class="form-control mb-3" id="nama" name="nama" placeholder="Nama" value="<?php echo isset($_POST['nama']) ? htmlspecialchars($_POST['nama']) : htmlspecialchars($data['nama']); ?>" required>
