...
$dataPicture   = $con->select_user($id);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$nama_file_lengkap == '') {
        ...
        $nama_file_br = $data['picture'];

        if ($username === $data['username'] && $email === $data['email']) {
            $data = $con->edit_user($id, $username, $email, $password, $level, $nama_file_br);
