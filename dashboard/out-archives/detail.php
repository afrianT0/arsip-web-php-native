...
require_once '../../dashboard/out-archives/proses/proses_detail.php';
...
<head>
    <meta charset="utf-8" />
    <title>Data Surat Keluar - Detail</title>
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Detail Data <b><?php echo htmlspecialchars(ucfirst($data['nomor'])); ?></b></h4>
                            </div>
                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <div class="form-control">
                                                    <a class="btn btn-xs btn-outline-secondary rounded-pill" href="../out-archives/file/<?php echo $data['file']; ?>" target="_blank"><i class="mdi mdi-link"></i> Lampiran</a>
                                                </div>
                                            </div>
                                        </div>
