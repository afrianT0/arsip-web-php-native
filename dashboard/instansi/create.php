...
require_once '../../dashboard/instansi/proses/proses_create.php';
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <input type="text" class="form-control <?php echo isset($pesan) ? 'is-invalid' : ''; ?>" id="nama" name="nama" placeholder="Nama" value="<?php echo isset($_POST['nama']) ? htmlspecialchars($_POST['nama']) : ''; ?>" required>
                                        ...
                                        <div class="row">
                                            <div class=" mb-2 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" value="<?php echo isset($_POST['alamat']) ? htmlspecialchars($_POST['alamat']) : ''; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class=" mb-2 col-md-6">
                                                ...
                                                <input type="tel" class="form-control" id="telepon" name="telepon" placeholder="Telepon" value="<?php echo isset($_POST['telepon']) ? htmlspecialchars($_POST['telepon']) : ''; ?>" required>
                                            </div>
                                        </div>
