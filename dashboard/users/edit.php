                                    ...
                                    <form method="post" action="<?php echo $url; ?>" class="needs-validation" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <input type="nama" class="form-control <?php echo isset($pesanNama) ? 'is-invalid' : ''; ?>" id="nama" name="nama" placeholder="Nama" value="<?php echo isset($_POST['nama']) ? htmlspecialchars($_POST['nama']) : htmlspecialchars($data['nama']); ?>" required>
                                            </div>
                                            <div class="mb-2 col-md-6">
