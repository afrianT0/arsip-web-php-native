...
<head>
    <meta charset="utf-8" />
    <title>Data Users - Pengarsipan</title>
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Data Users</h4>
                            </div>
                            <div class="col-lg-6">
                                        ...
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?= $counter++; ?></td>
                                                        <td><img src="../../assets/images/users/<?= $data["picture"] ?>" alt="image" class="img-fluid rounded-circle" width="30" />
                                                            <?= $data['username']; ?></td>
                                                        <td><?= $data['email']; ?></td>
                                                        <td><?= $data['level']; ?></td>
                                                        <td>
                                                            ...
                                                            <a class="btn btn-xs btn-soft-danger" onclick="hapus(this)" href="javascript:void(0);" data-id="<?= $data["id"]; ?>" data-key="<?= $data['username']; ?>">
