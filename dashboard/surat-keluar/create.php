...
require_once '../../dashboard/surat-keluar/proses/proses_create.php';
                                        ...
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <select class="form-control" name="kategori" id="kategori" data-toggle="select2">
                                                    ...
                                                    <?php
                                                    foreach ($con->get_data_kategori() as $data) {
                                                        $selected = isset($_POST['kategori']) && $_POST['kategori'] == $data['id'] ? 'selected' : '';
