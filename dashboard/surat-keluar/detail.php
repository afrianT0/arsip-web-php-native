...
require_once '../../dashboard/surat-keluar/proses/proses_detail.php';
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <div class="form-control">
                                                    <a class="btn btn-xs btn-outline-secondary rounded-pill" href="../../assets/file/<?php echo $data['file']; ?>" target="_blank"><i class="mdi mdi-link"></i> Lampiran</a>
                                                </div>
                                            </div>
                                        </div>
