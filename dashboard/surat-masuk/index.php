                                    ...
                                    <div class="table-responsive">
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $counter = 1;
                                                foreach ($con->get_data_surat_masuk() as $data) {
                                                ?>
                                                    <tr>
                                                        <td><?= $counter++; ?></td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-xs btn-soft-info" href="./detail?id=<?= $data["id"]; ?>"> <i class="mdi mdi-information-outline" style="font-size: 16px;"></i></a>

                                                            <?php
                                                            if ($_SESSION['username'] === $data['user_nama'] || $_SESSION['level'] === 'Administrator') {
                                                                echo '
