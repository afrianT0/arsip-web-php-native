...
require_once '../../dashboard/kategori/proses/proses_create.php';
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="needs-validation" novalidate>
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <input type="text" class="form-control <?php echo isset($pesan) ? 'is-invalid' : ''; ?>" id="nama" name="nama" placeholder="Nama" value="<?php echo isset($_POST['nama']) ? $_POST['nama'] : ''; ?>" required>
