...
require_once '../../dashboard/kategori/proses/proses_edit.php';
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Edit Data <?= $page; ?> <b><?php echo htmlspecialchars(ucfirst($data['nama'])); ?></b></h4>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <form method="post" action="<?php echo $url; ?>" class="needs-validation" novalidate>
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <input type="text" class="form-control <?php echo isset($pesan) ? 'is-invalid' : ''; ?>" id="nama" name="nama" placeholder="Nama" value="<?php echo isset($_POST['nama']) ? $_POST['nama'] : $data['nama'] ?>" required>
