...
require_once '../../dashboard/categories/proses/proses_edit.php';
...
<head>
    <meta charset="utf-8" />
    <title>Data Kategori Dokumen - Edit</title>
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Edit Data <b><?php echo htmlspecialchars(ucfirst($data['name'])); ?></b></h4>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <form method="post" action="<?php echo $url; ?>" class="needs-validation" novalidate>
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                ...
                                                <input type="text" class="form-control <?php echo isset($pesan) ? 'is-invalid' : ''; ?>" id="name" name="name" placeholder="Nama" value="<?php echo isset($_POST['name']) ? $_POST['name'] : $data['name'] ?>" required>
