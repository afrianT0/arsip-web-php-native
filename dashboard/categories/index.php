...
<head>
    <meta charset="utf-8" />
    <title>Data Kategori Dokumen - Pengarsipan</title>
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Data Kategori Dokumen</h4>
                            </div>
                            <div class="col-lg-6">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-xs btn-soft-danger" onclick="hapus(this)" href="javascript:void(0);" data-id="<?= $data["id"]; ?>" data-key="<?= $data['name']; ?>">
