            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Data <?= $page; ?></h4>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <div class="table-responsive">
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $counter = 1;
                                                foreach ($con->get_data_surat_tidak_valid() as $data) {
                                                ?>
                                                    <tr>
                                                        <td><?= $counter++; ?></td>
                                                        ...
                                                        <td><?= ucfirst($data['user_nama']); ?></td>
                                                        <td>
                                                            <a class="btn btn-xs btn-soft-danger" href="../../assets/file/<?= $data["file"]; ?>" target="_blank"><i class="mdi mdi-file-outline" style="font-size: 16px;"></i></a>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            if ($data['status'] == 1) {
                                                                ...
                                                                echo '<span class="badge text-bg-danger">Tidak Valid</span>';
                                                            }
                                                            ?>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <!-- <button type="button" class="btn btn-xs btn-soft-warning" data-bs-toggle="modal" data-bs-target="#modalEdit-<?= $data["id"]; ?>">
                                                                <i class="mdi mdi-square-edit-outline" style="font-size: 16px;"></i>
                                                            </button> -->

                                                            <a href="./edit?id=<?= $data["id"]; ?>" class="btn btn-xs btn-soft-warning" data-bs-toggle="modal" data-bs-target="#modalEdit-<?= $data["id"]; ?>">
                                                                <i class="mdi mdi-square-edit-outline" style="font-size: 16px;"></i>
                                                            </a>

                                                            <?php
                                                            include('../../dashboard/pending/edit.php');
                                                            ?>
